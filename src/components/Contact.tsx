              ...
              <div className="contact-info-card">
                ...
                <div className="contact-social">
                  {data.contactInfo.socialLinks.facebook && (
                    <a 
                      href={data.contactInfo.socialLinks.facebook}
                      target="_blank"
                  ...
                  {data.contactInfo.socialLinks.twitter && (
                    <a 
                      href={data.contactInfo.socialLinks.twitter}
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Twitter"
                    >
                  ...
                  {data.contactInfo.socialLinks.instagram && (
                    <a 
                      href={data.contactInfo.socialLinks.instagram}
                      target="_blank"
                      rel="noopener noreferrer"
